...
dBm_rate_con = xlsread('F:\Summer-Internship\raw data\p1_0cm.xlsx');
dBm_rate = xlsread('F:\Summer-Internship\raw data\apple_pear.xlsx');
power_rate  = 10.^(dBm_rate/10-3);
power_rate_con  = 10.^(dBm_rate_con/10-3);
...
for test_number = 1: test_num
    for repeat_number = 1: repeat_num
        path_ahead_1 = 'F:\Summer-Internship\raw data\apple_pear\04_00';
        path_ahead_2 = 'F:\Summer-Internship\raw data\apple_pear\03_01';
        path_ahead_3 = 'F:\Summer-Internship\raw data\apple_pear\02_02';
        path_ahead_4 = 'F:\Summer-Internship\raw data\apple_pear\01_03';
        path_ahead_5 = 'F:\Summer-Internship\raw data\apple_pear\00_04';
        path_ahead_6 = 'F:\Summer-Internship\raw data\apple_pear\03_00';
        path_ahead_7 = 'F:\Summer-Internship\raw data\apple_pear\02_01';
        path_ahead_8 = 'F:\Summer-Internship\raw data\apple_pear\01_02';
        path_ahead_9 = 'F:\Summer-Internship\raw data\apple_pear\00_03';
        path_ahead_10 = 'F:\Summer-Internship\raw data\apple_pear\02_00';
        path_ahead_11 = 'F:\Summer-Internship\raw data\apple_pear\01_01';
        path_ahead_12 = 'F:\Summer-Internship\raw data\apple_pear\00_02';
        path_ahead_13 = 'F:\Summer-Internship\raw data\apple_pear\01_00';
        path_ahead_14 = 'F:\Summer-Internship\raw data\apple_pear\00_01';

        path_ahead_contrast = 'F:\Summer-Internship\raw data\0cm\00';
        path_between = '_';
        path_behind = '.dat';

        %实验组path
        if test_number==1 && repeat_number < 10
            path_exp = [path_ahead_1,path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number==1 && repeat_number >= 10
            path_exp = [path_ahead_1,path_between,num2str(repeat_number),path_behind];
        end
        if test_number==2 && repeat_number < 10
            path_exp = [path_ahead_2,path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number==2 && repeat_number >= 10
            path_exp = [path_ahead_2,path_between,num2str(repeat_number),path_behind];
        end
        if test_number==3 && repeat_number < 10
            path_exp = [path_ahead_3,path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number==3 && repeat_number >= 10
            path_exp = [path_ahead_3,path_between,num2str(repeat_number),path_behind];
        end
        if test_number==4 && repeat_number < 10
            path_exp = [path_ahead_4,path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number==4 && repeat_number >= 10
            path_exp = [path_ahead_4,path_between,num2str(repeat_number),path_behind];
        end
        if test_number==5 && repeat_number < 10
            path_exp = [path_ahead_5,path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number==5 && repeat_number >= 10
            path_exp = [path_ahead_5,path_between,num2str(repeat_number),path_behind];
        end
        if test_number==6 && repeat_number < 10
            path_exp = [path_ahead_6,path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number==6 && repeat_number >= 10
            path_exp = [path_ahead_6,path_between,num2str(repeat_number),path_behind];
        end
        if test_number==7 && repeat_number < 10
            path_exp = [path_ahead_7,path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number==7 && repeat_number >= 10
            path_exp = [path_ahead_7,path_between,num2str(repeat_number),path_behind];
        end
        if test_number==8 && repeat_number < 10
            path_exp = [path_ahead_8,path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number==8 && repeat_number >= 10
            path_exp = [path_ahead_8,path_between,num2str(repeat_number),path_behind];
        end
        if test_number==9 && repeat_number < 10
            path_exp = [path_ahead_9,path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number==9 && repeat_number >= 10
            path_exp = [path_ahead_9,path_between,num2str(repeat_number),path_behind];
        end
        if test_number==10 && repeat_number < 10
            path_exp = [path_ahead_10,path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number==10 && repeat_number >= 10
            path_exp = [path_ahead_10,path_between,num2str(repeat_number),path_behind];
        end
        if test_number==11 && repeat_number < 10
            path_exp = [path_ahead_11,path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number==11 && repeat_number >= 10
            path_exp = [path_ahead_11,path_between,num2str(repeat_number),path_behind];
        end
        if test_number==12 && repeat_number < 10
            path_exp = [path_ahead_12,path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number==12 && repeat_number >= 10
            path_exp = [path_ahead_12,path_between,num2str(repeat_number),path_behind];
        end
        if test_number==13 && repeat_number < 10
            path_exp = [path_ahead_13,path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number==13 && repeat_number >= 10
            path_exp = [path_ahead_13,path_between,num2str(repeat_number),path_behind];
        end
        if test_number==14 && repeat_number < 10
            path_exp = [path_ahead_14,path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number==14 && repeat_number >= 10
            path_exp = [path_ahead_14,path_between,num2str(repeat_number),path_behind];
        end
        ...
        path_con = 'F:\Summer-Internship\raw data\0cm\00_01.dat';
        ...
        %power_caused_quotient = sqrt(power_rate(repeat_number,test_number)/power_rate_con(repeat_number,1));
