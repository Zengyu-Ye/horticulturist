...
dBm_rate = xlsread('F:\Summer-Internship\raw data\paperbox_thick_extra.xlsx');
...
for test_number = 1: test_num
    for repeat_number = 1: repeat_num
        path_ahead = 'F:\Summer-Internship\raw data\box_comparison\paperbox_thick_';
        ...
        if test_number<10 && repeat_number < 10
            path_exp = [path_ahead,'0',num2str(test_number-1),path_between,'0',num2str(repeat_number),path_behind];
        end
        if test_number<10 && repeat_number >= 10
            path_exp = [path_ahead,'0',num2str(test_number-1),path_between,num2str(repeat_number),path_behind];
        end
        if test_number>=10 && repeat_number < 10
            path_exp = [path_ahead,num2str(test_number-1),path_between, '0',num2str(repeat_number),path_behind];
        end
        if test_number>=10 && repeat_number >= 10
            path_exp = [path_ahead,num2str(test_number-1),path_between, num2str(repeat_number),path_behind];
        end
        ...
        path_con = 'F:\Summer-Internship\raw data\box_comparison\paperbox_thick_empty.dat';
